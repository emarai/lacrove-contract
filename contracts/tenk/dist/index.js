...
var Contract = /** @class */ (function () {
    ...
    */
    ...
    Contract.prototype.add_freemint_accounts = function (args, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = helper_1.providers).getTransactionLastResult;
                        return [4 /*yield*/, this.add_freemint_accountsRaw(args, options)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                }
            });
        });
    };
    Contract.prototype.add_freemint_accountsRaw = function (args, options) {
        return this.account.functionCall(__assign({ contractId: this.contractId, methodName: "add_freemint_accounts", args: args }, options));
    };
    Contract.prototype.add_freemint_accountsTx = function (args, options) {
        var _a, _b;
        return helper_1.transactions.functionCall("add_freemint_accounts", args, (_a = options === null || options === void 0 ? void 0 : options.gas) !== null && _a !== void 0 ? _a : helper_1.DEFAULT_FUNCTION_CALL_GAS, (_b = options === null || options === void 0 ? void 0 : options.attachedDeposit) !== null && _b !== void 0 ? _b : new helper_1.BN(0));
    };
    Contract.prototype.remove_freemint_account = function (args, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = helper_1.providers).getTransactionLastResult;
                        return [4 /*yield*/, this.remove_freemint_accountRaw(args, options)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                }
            });
        });
    };
    Contract.prototype.remove_freemint_accountRaw = function (args, options) {
        return this.account.functionCall(__assign({ contractId: this.contractId, methodName: "remove_freemint_account", args: args }, options));
    };
    Contract.prototype.remove_freemint_accountTx = function (args, options) {
        var _a, _b;
        return helper_1.transactions.functionCall("remove_freemint_account", args, (_a = options === null || options === void 0 ? void 0 : options.gas) !== null && _a !== void 0 ? _a : helper_1.DEFAULT_FUNCTION_CALL_GAS, (_b = options === null || options === void 0 ? void 0 : options.attachedDeposit) !== null && _b !== void 0 ? _b : new helper_1.BN(0));
    };
    /**
    ...
    */
    ...
    Contract.prototype.freeminted = function (args, options) {
        return this.account.viewFunction(this.contractId, "freeminted", args, options);
    };
    /**
