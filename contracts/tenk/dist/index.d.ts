...
export declare type AddFreemintAccounts__Result = boolean;
/**
*
* @contractMethod change
*/
...
export declare type RemoveFreemintAccount__Result = u16 | null;
/**
* Remove whitelisted account. If account is removed, the number of tokens left in returned.
* @allow ["::admins", "::owner"]
*
...
export declare type Freeminted__Result = boolean;
/**
* Cost of NFT + fees for linkdrop
*
* @contractMethod view
