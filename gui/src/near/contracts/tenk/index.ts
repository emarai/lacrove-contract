...
export class Contract {
  ...
  */
  ...
  async add_freemint_accounts(args: {
    accounts: Record<AccountId, u16>;
  }, options?: ChangeMethodOptions): Promise<boolean> {
    return providers.getTransactionLastResult(await this.add_freemint_accountsRaw(args, options));
  }
  add_freemint_accountsRaw(args: {
    accounts: Record<AccountId, u16>;
  }, options?: ChangeMethodOptions): Promise<providers.FinalExecutionOutcome> {
    return this.account.functionCall({contractId: this.contractId, methodName: "add_freemint_accounts", args, ...options});
  }
  add_freemint_accountsTx(args: {
    accounts: Record<AccountId, u16>;
  }, options?: ChangeMethodOptions): transactions.Action {
    return transactions.functionCall("add_freemint_accounts", args, options?.gas ?? DEFAULT_FUNCTION_CALL_GAS, options?.attachedDeposit ?? new BN(0))
  }
  async remove_freemint_account(args: {
    account_id: AccountId;
  }, options?: ChangeMethodOptions): Promise<u16 | null> {
    return providers.getTransactionLastResult(await this.remove_freemint_accountRaw(args, options));
  }
  remove_freemint_accountRaw(args: {
    account_id: AccountId;
  }, options?: ChangeMethodOptions): Promise<providers.FinalExecutionOutcome> {
    return this.account.functionCall({contractId: this.contractId, methodName: "remove_freemint_account", args, ...options});
  }
  remove_freemint_accountTx(args: {
    account_id: AccountId;
  }, options?: ChangeMethodOptions): transactions.Action {
    return transactions.functionCall("remove_freemint_account", args, options?.gas ?? DEFAULT_FUNCTION_CALL_GAS, options?.attachedDeposit ?? new BN(0))
  }
  /**
...
* @contractMethod change
*/
export interface AddFreemintAccounts {
  args: {
    accounts: Record<AccountId, u16>;
  };
  options: {
...
export type AddFreemintAccounts__Result = boolean;
/**
* 
* @contractMethod change
*/
export interface RemoveFreemintAccount {
  args: {
    account_id: AccountId;
  };
  options: {
...
export type RemoveFreemintAccount__Result = u16 | null;
/**
* Remove whitelisted account. If account is removed, the number of tokens left in returned.
* @allow ["::admins", "::owner"]
* 
...
* @contractMethod view
*/
export interface Freeminted {
  args: {
    account_id: AccountId;
  };
  
}
export type Freeminted__Result = boolean;
/**
* Cost of NFT + fees for linkdrop
* 
* @contractMethod view
